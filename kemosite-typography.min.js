...
1,a[8],typography_obj.user_configuration.font_height_pixels)};this.activate_kemosite_typography=function(a){var b=a.replace("_","-");a=document.createElement("style");a.setAttribute("type","text/css");b=":root { --kemosite-typography-100: "+typography_obj.outputs.font_height_pixels_100+"px;--kemosite-typography-200: "+typography_obj.outputs.font_height_pixels_200+"px;--kemosite-typography-300: "+typography_obj.outputs.font_height_pixels_300+"px;--kemosite-typography-400: "+typography_obj.outputs.font_height_pixels_400+
"px;--kemosite-typography-500: "+typography_obj.outputs.font_height_pixels_500+"px;--kemosite-typography-600: "+typography_obj.outputs.font_height_pixels_600+"px;--kemosite-typography-700: "+typography_obj.outputs.font_height_pixels_700+"px;--kemosite-typography-800: "+typography_obj.outputs.font_height_pixels_800+"px;--kemosite-typography-900: "+typography_obj.outputs.font_height_pixels_900+"px;} html { font-size: var(--kemosite-typography"+b+") !important;} ";a.styleSheet?a.styleSheet.cssText=b:
a.appendChild(document.createTextNode(b));document.getElementsByTagName("head")[0].insertBefore(a,document.getElementsByTagName("head")[0].childNodes[0])};this.recursive_locate_text=function(a){return a.childNodes&&0<a.childNodes.length&&"#text"!==a.childNodes[0].nodeName?typography_obj.recursive_locate_text(a.childNodes[0]):a};this.orphans_control=function(){if(window.matchMedia("(min-width: 39ch)").matches)for(var a=document.querySelectorAll("body.activate_kemosite_typography.orphan_control h1, body.activate_kemosite_typography.orphan_control h2, body.activate_kemosite_typography.orphan_control h3, body.activate_kemosite_typography.orphan_control h4, body.activate_kemosite_typography.orphan_control h5, body.activate_kemosite_typography.orphan_control h6, body.activate_kemosite_typography.orphan_control p,body.activate_kemosite_typography.orphan_control td,body.activate_kemosite_typography.orphan_control figcaption,body.activate_kemosite_typography.orphan_control li"),
b=RegExp("[(!|.|,|?|:|;)]","g"),h=0;h<a.length;h++){var f=typography_obj.recursive_locate_text(a[h]);if(f.childNodes&&1==f.childNodes.length&&null!==f.childNodes[0].nodeValue&&f.childNodes[0].nodeValue.includes(" ")){var c=f.childNodes[0].nodeValue.toString(),g=c.match(b);c=c.split(b);var k=[];if(null!==g&&0<g.length){for(var d=0;d<c.length;d++){var e=c[d].match(new RegExp(/\b(\p{L}+?)\b/,"giu")),m=new RegExp(/^(\s*)([\p{L}]*['"\u2018\u2019\u201c\u201d]*[\p{L}]*)(?:\s)([\p{L}]*['"\u2018\u2019\u201c\u201d]*[\p{L}]*)/,
"giu"),l=new RegExp(/([\p{L}]*['"\u2018\u2019\u201c\u201d]*[\p{L}]*)(?:\s)([\p{L}]*['"\u2018\u2019\u201c\u201d]*[\p{L}]*)$/,"giu");c[d]=c[d].replace("\n","");null!==e&&3==e.length?(e=c[d].replace(l,"$1&nbsp;$2"),c[d]=e):null!==e&&3<e.length&&(e=c[d].replace(m,"$1$2&nbsp;$3").replace(l,"$1&nbsp;$2"),c[d]=e);k[d]=g[d]?c[d]+g[d]:c[d]}c=k.join("");f.innerHTML=c}}}}};